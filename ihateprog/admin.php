...
$supplier_query = "SELECT * FROM registration WHERE roles IN ('a', 's', 'm', 'd', 'r')";
            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <div class="sb-sidenav-menu-heading">Inventory of supplier and manufacturer</div>
