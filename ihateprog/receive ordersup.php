...
<head>
    ...
    <title>Receive order from manufacuturer</title>
...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <!-- Navbar Brand-->
        <a class="navbar-brand ps-3" href="index.html">order from manufacuturer</a>
        <!-- Sidebar Toggle-->
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Receive Order</h1>
...
while ($row_product = mysqli_fetch_assoc($product_result)) {
    ...
    // Outputting the receive order in sentence format
