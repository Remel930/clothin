...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <!-- Navbar Brand-->
        <a class="navbar-brand ps-3" href="#">Transaction History</a>
        <!-- Sidebar Toggle-->
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    ...
                    <div>
                        <form action="update stats D.php" method="post">
                            <?php
                                $product_query = "SELECT * FROM retailerorders";
                                ...
                                while ($row_product = mysqli_fetch_assoc($product_result)) {
                                    ...
                                    echo "$name ($email and the manufacturer's phone number is: $phone) ordered $item, $quantity quantities, gender $gender, size $size. Shipping address: $shipping_address. The payment method is $payment_method, and the shipping method is $shipping_method. Order placed on: $order_date. Total Price: $total_price. Status: $status";
                                    echo '<button type="button" class="btn btn-primary" onclick="showConfirmation(' . $id . ')">Update Status</button>';
                                    echo "<br><br>";
                                }
                            ?>
                        </form>
    ...
    <script>
        function showConfirmation(id) {
            var result = confirm("Do you want to change it to delivered?");
            if (result) {
                window.location.href = "update stats D.php?id=" + id;
            }
        }
    </script>
</body>
